...
-   Um alle Nachrichten zu löschen (ähnlich "Verlauf löschen" im Client) fügt man bei einem Menupunkt `menu:deleteAll:Navigation` - **Navigation** ist der Menu-Name, der anschliessend aufgerufen werden soll (z.b. Startmenu)
